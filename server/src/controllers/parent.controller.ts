...
const ParentController = {
  ...
  async uploadAvatar(_req: Request, res: Response) {
    const response = await ParentService.uploadAvatar(
  ...
  async getActiveByStudent(_req: Request, res: Response) {
    const response = await ParentService.getActiveByStudent(
